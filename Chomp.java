...
public class Chomp extends Application implements GameInterface {

    private static final String[] TEAMS = {"Player 1", "Player 2"};
    private static final String[] buttonImages = {"    ", "cookie.png", "bad_cookie.png"};
    ...
    public final String saveFile = "csave.txt";
    private Stage stage;
    ...
    public void saveGame() {
        try {
            ...
            PrintWriter pr = new PrintWriter("csave.txt");
            pr.println(101);
